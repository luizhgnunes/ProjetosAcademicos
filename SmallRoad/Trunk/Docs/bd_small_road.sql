...
--
-- Estrutura da tabela `tb_destinatario`
--

CREATE TABLE `tb_destinatario` (
  `DES_ID` int(11) NOT NULL,
  `DES_NOME` varchar(50) NOT NULL,
  `DES_CPF_CNPJ` varchar(14) NOT NULL,
  `DES_LATITUDE` varchar(10) NOT NULL,
  `DES_LONGITUDE` varchar(10) NOT NULL,
  `DES_ENDERECO` varchar(255) NOT NULL COMMENT 'Rua com o número e o complemento.',
...
CREATE TABLE `tb_entrega` (
  ...
  `ENT_SEQUENCIA` int(3) NOT NULL,
  `SE_ID` int(11) NOT NULL,
  `ENT_OBSERVACAO` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `tb_municipio` (`mun_id`, `est_uf`, `mun_nome`) VALUES
...
--
-- Estrutura da tabela `tb_roteiro_motorista`
--
...
--
-- Estrutura da tabela `tb_status_entrega`
--

CREATE TABLE `tb_status_entrega` (
  `SE_ID` int(11) NOT NULL,
  `SE_DESCRICAO` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `tb_usuario` (
  ...
  `USU_TIPO` char(1) NOT NULL COMMENT 'G = Gerente; M = Motorista',
  `USU_CPF_CNPJ` varchar(14) NOT NULL,
  `USU_EMAIL` varchar(55) NOT NULL,
  `USU_DDD` char(2) NOT NULL,
  `USU_TELEFONE` varchar(10) NOT NULL,
  `USU_ENDERECO` varchar(55) NOT NULL,
  ...
  `USU_STATUS` char(1) NOT NULL COMMENT 'A = Ativo; I = Inativo.'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Indexes for table `tb_destinatario`
--
...
ALTER TABLE `tb_entrega`
  ADD PRIMARY KEY (`RM_ID`,`NF_NUMERO`),
  ADD KEY `SE_ID` (`SE_ID`),
  ADD KEY `TB_ENTREGA_FK02` (`NF_NUMERO`);
...
--
-- Indexes for table `tb_municipio`
--
...
ALTER TABLE `tb_nota_fiscal`
  ADD PRIMARY KEY (`NF_NUMERO`),
  ADD KEY `DES_ID` (`DES_ID`);

--
-- Indexes for table `tb_roteiro_motorista`
--
...
ALTER TABLE `tb_usuario`
  ...
  ADD UNIQUE KEY `TB_USUARIO_UNQ1` (`USU_LOGIN`),
  ADD UNIQUE KEY `TB_USUARIO_UNQ2` (`USU_EMAIL`),
  ADD KEY `MUN_ID` (`MUN_ID`);
...
--
-- AUTO_INCREMENT for table `tb_destinatario`
--
ALTER TABLE `tb_destinatario`
...
--
ALTER TABLE `tb_nota_fiscal`
  MODIFY `NF_NUMERO` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `tb_roteiro_motorista`
--
ALTER TABLE `tb_roteiro_motorista`
  MODIFY `RM_ID` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `tb_status_entrega`
--
ALTER TABLE `tb_status_entrega`
...
--
-- Limitadores para a tabela `tb_destinatario`
--
ALTER TABLE `tb_destinatario`
  ADD CONSTRAINT `TB_DESTINATARIO_FK01` FOREIGN KEY (`MUN_ID`) REFERENCES `tb_municipio` (`mun_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Limitadores para a tabela `tb_entrega`
--
ALTER TABLE `tb_entrega`
  ADD CONSTRAINT `TB_ENTREGA_FK01` FOREIGN KEY (`RM_ID`) REFERENCES `tb_roteiro_motorista` (`RM_ID`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `TB_ENTREGA_FK02` FOREIGN KEY (`NF_NUMERO`) REFERENCES `tb_nota_fiscal` (`NF_NUMERO`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `TB_ENTREGA_FK03` FOREIGN KEY (`SE_ID`) REFERENCES `tb_status_entrega` (`SE_ID`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Limitadores para a tabela `tb_municipio`
--
ALTER TABLE `tb_municipio`
  ADD CONSTRAINT `TB_MUNICIPIO_FK01` FOREIGN KEY (`est_uf`) REFERENCES `tb_estado` (`est_uf`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Limitadores para a tabela `tb_nota_fiscal`
--
ALTER TABLE `tb_nota_fiscal`
  ADD CONSTRAINT `TB_NOTA_FISCAL_FK01` FOREIGN KEY (`DES_ID`) REFERENCES `tb_destinatario` (`DES_ID`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `tb_usuario`
  ADD CONSTRAINT `TB_USUARIO_FK10` FOREIGN KEY (`MUN_ID`) REFERENCES `tb_municipio` (`mun_id`) ON DELETE CASCADE ON UPDATE CASCADE;
